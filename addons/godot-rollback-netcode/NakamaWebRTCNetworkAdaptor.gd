...
func detach_network_adaptor(sync_manager) -> void:
	if OnlineMatch:
		if OnlineMatch.webrtc_peer_added.is_connected(_on_OnlineMatch_webrtc_peer_added):
			OnlineMatch.webrtc_peer_added.disconnect(_on_OnlineMatch_webrtc_peer_added)
		if OnlineMatch.webrtc_peer_removed.is_connected(_on_OnlineMatch_webrtc_peer_removed):
			OnlineMatch.webrtc_peer_removed.disconnect(_on_OnlineMatch_webrtc_peer_removed)
		if OnlineMatch.disconnected.is_connected(_on_OnlineMatch_disconnected):
