...
var _api_client : NakamaAPI.ApiClient:
	set = _no_set, get = _no_get

var auto_refresh : bool = true:
	set = set_auto_refresh, get = get_auto_refresh
var auto_refresh_seconds : int = true:
	set = set_auto_refresh_seconds, get = get_auto_refresh_seconds
var auto_retry : bool = true:
	set = set_auto_retry, get = get_auto_retry
var auto_retry_count:
	set = set_auto_retry_count, get = get_auto_retry_count
var auto_retry_backoff_base:
	set = set_auto_retry_backoff_base, get = get_auto_retry_backoff_base
var last_cancel_token:
	set = _no_set, get = get_last_cancel_token
